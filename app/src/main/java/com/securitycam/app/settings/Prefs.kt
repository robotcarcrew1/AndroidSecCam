...
class Prefs(context: Context) {
    ...
    /** Governs how soon a *new* object (a different category, or the same category in a
     *  different spot) can start its own recording after the previous one ends. A
     *  lingering object that's already been recorded/alerted on (e.g. a parked car) is
     *  suppressed entirely instead — see MonitorService.isSameObjectAsLastAlert — so this
     *  cooldown mainly bounds how fast genuinely new detections can arrive. */
